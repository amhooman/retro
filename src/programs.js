...
add_icon_not_via_filesystem({
    ...
    open: function() { Explorer("https://google.com"); },
    shortcut: true
});
add_icon_not_via_filesystem({
    title: "Notepad",
...
add_icon_not_via_filesystem({
    ...
    open: function() {
        Task(make_iframe_window({
            ...
            icons: iconsAtTwoSizes("js-solitaire"),
            title: "solitaire",
            outerWidth: 660,
            outerHeight: 470,
            resizable: true,
...
add_icon_not_via_filesystem({
    title: "Chat for Slash",
    iconID: "chat",
    open: function() {
        Task(make_iframe_window({
            src: "/chat4slash/index.html",
            icons: iconsAtTwoSizes("chat"),
            title: "Chat For Slash",
            outerWidth: 600,
            outerHeight: 475,
